...
// node_modules/@mappedin/mappedin-js/lib/esm/chunk-3A3IZSQH.js
q();
function R(o, l = false) {
  let r2 = o[0].index !== null, f = new Set(Object.keys(o[0].attributes)), i = new Set(Object.keys(o[0].morphAttributes)), c = {}, e = {}, h = o[0].morphTargetsRelative, u = new Le(), d = 0;
  for (let t = 0; t < o.length; ++t) {
    let s = o[t], a = 0;
    if (r2 !== (s.index !== null)) return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index " + t + ". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."), null;
...
function T(o) {
  ...
  for (let d = 0; d < o.length; ++d) {
    ...
    if (r2 === void 0 && (r2 = t.itemSize), r2 !== t.itemSize) return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."), null;
  ...
  let e = new l(c), h = new Se(e, r2, f), u = 0;
  for (let d = 0; d < o.length; ++d) {
    let t = o[d];
    if (t.isInterleavedBufferAttribute) {
      let s = u / r2;
      for (let a = 0, n = t.count; a < n; a++) for (let m = 0; m < r2; m++) {
...
r(T, "mergeAttributes");
function X(o, l) {
  if (l === pv) return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."), o;
  if (l === gv || l === mv) {
    let r2 = o.getIndex();
    if (r2 === null) {
    ...
    let f = r2.count - 2, i = [];
    if (l === gv) for (let e = 1; e <= f; e++) i.push(r2.getX(0)), i.push(r2.getX(e)), i.push(r2.getX(e + 1));
    else for (let e = 0; e < f; e++) e % 2 === 0 ? (i.push(r2.getX(e)), i.push(r2.getX(e + 1)), i.push(r2.getX(e + 2))) : (i.push(r2.getX(e + 2)), i.push(r2.getX(e + 1)), i.push(r2.getX(e)));
...
r(X, "toTrianglesDrawMode");

export {
  R,
  X
};
//# sourceMappingURL=chunk-Z4ENL6JO.js.map
